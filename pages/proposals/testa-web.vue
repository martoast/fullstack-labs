          ...
          <div class="mt-5 sm:mt-6 bg-sky-50 border border-sky-200 rounded-lg p-4 sm:p-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
            <div>
              ...
              <p class="text-xs text-sky-500 mt-1 leading-relaxed">
                ...
                <span class="font-semibold text-green-600">✓ Pago inicial recibido ($225 USD, 28 de agosto, 2026)</span><br />
                <span class="font-semibold text-sky-700">✓ Sitio entregado · Pago final facturado ($225 USD, factura #6F72A30A-0013, 16 de septiembre, 2026) — pendiente de pago</span>
              </p>
            </div>
